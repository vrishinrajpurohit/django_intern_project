...
from .views import Signupview,ProfileView,ProfileUpdateView,ProfileDeleteView,ProfileBlogView
...
urlpatterns = [
    ...
    path('profile/blogs', ProfileBlogView.as_view(),name="profileblog"),
